...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/system_configurations', 'SystemConfigurationsController@index')->name('system-configurations.api');
    Route::post('/system_configurations/manage', 'SystemConfigurationsController@manage')->name('system-configurations-manage.api');
});
